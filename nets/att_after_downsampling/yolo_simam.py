...
from nets.backbone import Backbone, Block, Conv, SiLU, Transition, simam_module, autopad
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, pretrained=False):
        ...
        self.simam_for_downsample1  = simam_module()
        ...
        self.simam_for_downsample2  = simam_module()
    ...
    def forward(self, x):
        ...
        P3_downsample = self.simam_for_downsample1(P3_downsample)
        P4 = torch.cat([P3_downsample, P4], 1)
        P4 = self.conv3_for_downsample1(P4)

        P4_downsample = self.down_sample2(P4)
        P4_downsample = self.simam_for_downsample2(P4_downsample)
